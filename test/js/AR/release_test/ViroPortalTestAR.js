...
var Uri360Video = {
  uri: "https://s3-us-west-2.amazonaws.com/viro/360_surf.mp4",
};
    ...
    return (
      <ViroARScene>
        ...
        >
          <ViroPortal>
            <Viro3DObject
              source={require("../res/portal_ring.obj")}
              position={[0, 0, 0]}
              rotation={[0, 0, 0]}
        ...
        <ViroPortalScene
          passable={true}
          position={[0, 0, -portalDistance + offsetTorwardsCamera]}
          scale={[1, 1, 1]}
        ...
        >
          ...
          <Viro360Video source={Uri360Video} loop={true} />

          <Viro3DObject
            source={require("../../release_test/res/earth_obj.obj")}
            resources={[
              require("../../release_test/res/earth_jpg.jpg"),
          ...
          <ViroPortalScene
            position={[0, 0, -portalDistance * 2 + offsetTorwardsCamera]}
            scale={[1, 1, 1]}
            passable={true}
          >
            <ViroPortal>
        ...
        <ViroPortalScene
          position={[0, 0, -portalDistance * 3 + offsetTorwardsCamera]}
          passable={true}
          scale={[1, 1, 1]}
        >
          <ViroPortal>
...
ViroAnimations.registerAnimations({
  ...
  forward: {
    properties: { positionZ: "-=" + portalDistance },
    duration: 3000,
    delay: 1000,
  },
  backward: {
  ...
  moveRight: {
    properties: { positionX: "+=" + portalDistance },
    duration: 3000,
    delay: 0,
  },
  moveLeft: {
  ...
  leftRightMove: [["moveLeft", "moveRight", "moveRight", "moveLeft"]],
  sequentialAnim: [
    [
      "forward",
      "forward",
