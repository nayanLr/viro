...
var ARTests = [
  {
    name: "ARSceneAndNavigatorTest",
    scene: require("./js/AR/release_test/ARSceneAndNavigatorTest"),
  },
  { name: "ARDragTest", scene: require("./js/AR/release_test/ARDragTest") },
  {
    name: "ARFBXVersionTest",
    scene: require("./js/AR/release_test/ARFBXVersionTest"),
  },
  {
    name: "ARPlaneSelectorTest",
    scene: require("./js/AR/release_test/ARPlaneSelectorTest"),
  },
  { name: "ARPlaneTest", scene: require("./js/AR/release_test/ARPlaneTest") },
  {
    name: "ARPlaneManualTest",
    scene: require("./js/AR/release_test/ARPlaneManualTest"),
  },
  { name: "ARHitTest", scene: require("./js/AR/release_test/ARHitTest") },
  {
    name: "ARHitTestCamera",
    scene: require("./js/AR/release_test/ARHitTestCamera"),
  },
  {
    name: "ARViroPortalTest",
    scene: require("./js/AR/release_test/ViroPortalTestAR"),
  },
  {
    name: "ARViroPostProcessTest",
    scene: require("./js/AR/release_test/ViroPostProcessTestAR"),
  },
  {
    name: "ARImageMarkerTest",
    scene: require("./js/AR/release_test/ARImageMarkerTest"),
  },
  {
    name: "ARObjectMarkerTest",
    scene: require("./js/AR/release_test/ARObjectMarkerTest"),
  },
  { name: "ARPbrTest", scene: require("./js/AR/release_test/ViroPbrTestAR") },
  {
    name: "ARPbrTestSurfacesAR",
    scene: require("./js/AR/release_test/ViroPbrTestSurfacesAR"),
  },
  { name: "ARShadowTest", scene: require("./js/AR/release_test/ARShadowTest") },
  {
    name: "ARPolygonPlaneTest",
    scene: require("./js/AR/release_test/ARPolygonPlaneTest"),
  },
  {
    name: "ARCameraHUDTest",
    scene: require("./js/AR/release_test/ARCameraHUDTest"),
  },
  {
    name: "ARImageTrackingTest",
    scene: require("./js/AR/release_test/ARImageTrackingTest"),
  },
  { name: "AR-First", scene: require("./js/ARCore/firstDemo") },
];
var VRTests = [
  { name: "SkyBoxTest", scene: require("./js/release_test/ViroSkyBoxTest") },
  {
    name: "360ImageTest",
    scene: require("./js/release_test/Viro360ImageTest"),
  },
  {
    name: "360VideoTest",
    scene: require("./js/release_test/Viro360VideoTest"),
  },
  { name: "VideoTest", scene: require("./js/release_test/ViroVideoTest") },
  {
    name: "AnimatedComponentTest",
    scene: require("./js/release_test/ViroAnimatedComponentTest"),
  },
  ...
  {
    name: "QuadFlexViewTest",
    scene: require("./js/release_test/ViroQuadFlexViewTest"),
  },
  { name: "ImageTest", scene: require("./js/release_test/ViroImageTest") },
  { name: "TextTest", scene: require("./js/release_test/ViroTextTest") },
  {
    name: "3DObjectTest",
    scene: require("./js/release_test/Viro3DObjectTest"),
  },
  { name: "CameraTest", scene: require("./js/release_test/ViroCameraTest") },
  { name: "SceneTest", scene: require("./js/release_test/SceneTest1") },
  {
    name: "AnimationTest",
    scene: require("./js/release_test/ViroAnimationTest"),
  },
  { name: "SoundTest", scene: require("./js/release_test/ViroSoundTest") },
  { name: "LightTest", scene: require("./js/release_test/ViroLightTest") },
  {
    name: "GroupTestBasicProps",
    scene: require("./js/release_test/GroupTestBasicProps"),
  },
  {
    name: "GroupTestBasicAnimation",
    scene: require("./js/release_test/GroupTestBasicAnimation"),
  },
  {
    name: "GroupTestBasicBillboard",
    scene: require("./js/release_test/GroupTestBasicBillboard"),
  },
  {
    name: "GroupTestMaterials",
    scene: require("./js/release_test/GroupTestMaterials"),
  },
  {
    name: "GroupTestBasicEvents",
    scene: require("./js/release_test/GroupTestBasicEvents"),
  },
  {
    name: "GroupTestDragEvents",
    scene: require("./js/release_test/GroupTestDragEvents"),
  },
  {
    name: "PhysicsGroupTest",
    scene: require("./js/release_test/PhysicsGroupTest"),
  },
  {
    name: "PhysicsForcesTest",
    scene: require("./js/release_test/PhysicsForcesTest"),
  },
  {
    name: "PhysicsCollisionTest",
    scene: require("./js/release_test/PhysicsCollisionTest"),
  },
  {
    name: "PhysicsPropertiesTest",
    scene: require("./js/release_test/PhysicsPropertiesTest"),
  },
  {
    name: "PhysicsScaleTest",
    scene: require("./js/release_test/PhysicsScaleTest"),
  },
  {
    name: "ParticleTest",
    scene: require("./js/release_test/ViroParticleTest"),
  },
  {
    name: "ShadowGroupTest",
    scene: require("./js/release_test/ViroShadowGroupTest"),
  },
  { name: "ShadowTest", scene: require("./js/release_test/ViroShadowTest") },
  {
    name: "PortalTestVR",
    scene: require("./js/release_test/ViroPortalTestVR"),
  },
  {
    name: "FlexViewLayoutTest",
    scene: require("./js/release_test/ViroFlexViewLayoutTest"),
  },
  {
    name: "AnimatedImageTest",
    scene: require("./js/release_test/ViroAnimatedImageTest"),
  },
  {
    name: "PolylineTest",
    scene: require("./js/release_test/ViroPolylineTest"),
  },
  { name: "PbrTest", scene: require("./js/release_test/ViroPbrTest") },
  {
    name: "BlendingTest",
    scene: require("./js/release_test/ViroBlendingTest"),
  },
  {
    name: "InternationalTextTest",
    scene: require("./js/release_test/ViroInternationalTextTest"),
  },
  { name: "FontTest", scene: require("./js/release_test/ViroFontTextTest") },
  {
    name: "MaterialVideoTest",
    scene: require("./js/release_test/ViroMaterialVideoTest"),
  },
  { name: "GLTFTest", scene: require("./js/release_test/ViroGLTFTest") },
  {
    name: "HierarchyTest",
    scene: require("./js/release_test/ViroHierarchyTest"),
  },
  {
    name: "CameraHUDTest",
    scene: require("./js/release_test/ViroCameraHUDTest"),
  },
  {
    name: "ChromaKeyTest",
    scene: require("./js/release_test/ViroChromaKeyTest"),
  },
  { name: "PolygonTest", scene: require("./js/release_test/ViroPolygonTest") },
  {
    name: "TextSpecialTest",
    scene: require("./js/release_test/ViroTextSpecialTest"),
  },
  {
    name: "ColorMaskTest",
    scene: require("./js/release_test/ViroColorMaskTest"),
  },
  {
    name: "GeometryTest",
    scene: require("./js/release_test/ViroGeometryTest"),
  },
];
var SceneTests = [
  {
...
export default class ViroExperienceSelector extends Component {
  GetSectionListItem = (section, item) => {
    ...
    if (section.title == "AR Tests") {
      this.setState({ navigatorType: AR_NAVIGATOR_TYPE, initialScene: item });
    } else if (section.title == "VR Tests") {
      this.setState({ navigatorType: VR_NAVIGATOR_TYPE, initialScene: item });
    } else if (section.title == "Scene Tests") {
      this.setState({
        navigatorType: SCENE_NAVIGATOR_TYPE,
        initialScene: item,
      });
    }
  };
  ...
  constructor() {
    ...
    this.state = {
      navigatorType:
        Config.VR_PLATFORM == "OVR_MOBILE" ? VR_NAVIGATOR_TYPE : UNSET,
    ...
    this._toggleNumberOfTrackedImages =
      this._toggleNumberOfTrackedImages.bind(this);
    this._handleARSupported = this._handleARSupported.bind(this);
    this._handleARNotSupported = this._handleARNotSupported.bind(this);
    this._getInitialSelectionButtons =
      this._getInitialSelectionButtons.bind(this);
  ...
  render() {
    if (this.state.navigatorType == UNSET) {
      ...
      this.state.navigatorType == VR_DEPRECATED_TYPE
    ) {
      ...
      <SafeAreaView style={localStyles.outer}>
        <SectionList
          ...
          renderSectionHeader={({ section }) => (
            <Text style={localStyles.sectionHeaderStyle}>
              {" "}
              {section.title}{" "}
            </Text>
          )}
          renderItem={({ item, section }) => (
            ...
            <Text
              ...
              //Item Separator View
              onPress={this.GetSectionListItem.bind(this, section, item.scene)}
            >
              {item.name}
            </Text>
          )}
    ...
    return (
      <SafeAreaView style={localStyles.outer}>
        <View style={localStyles.inner}>
          <Text style={localStyles.titleText}>{this._getTitleText()}</Text>

          <TouchableHighlight
            style={
              this.state.navigatorType == UNSET
                ? localStyles.buttons
                : localStyles.vrModeButtons
            }
            onPress={() => {
              this.setState({
                initial3DScene: require("./js/release_test/GroupTestBasicEvents"),
              });
            }}
            underlayColor={"#68a0ff"}
          >
            <Text style={localStyles.buttonText}>{this._getButtonText(1)}</Text>
          </TouchableHighlight>
          ...
          <TouchableHighlight
            ...
            onPress={() => {
              this.setState({
                initial3DScene: require("./js/release_test/GroupTestDragEvents"),
              });
            }}
            underlayColor={"#68a0ff"}
          >
            <Text style={localStyles.buttonText}>{this._getButtonText(2)}</Text>
          </TouchableHighlight>
          ...
          <TouchableHighlight
            ...
            onPress={() => {
              this.setState({
                initial3DScene: require("./js/release_test/ViroVideoTest"),
              });
            }}
            underlayColor={"#68a0ff"}
          >
            <Text style={localStyles.buttonText}>{this._getButtonText(3)}</Text>
          </TouchableHighlight>
          ...
          <TouchableHighlight
            ...
            onPress={() => {
              this.setState({
                initial3DScene: require("./js/release_test/ViroSoundTest"),
              });
            }}
            underlayColor={"#68a0ff"}
          >
            <Text style={localStyles.buttonText}>{this._getButtonText(4)}</Text>
          </TouchableHighlight>
        </View>
      </SafeAreaView>
    );
  ...
  _getButtonPress(buttonNum) {
    if (buttonNum == 1) {
      if (this.state.navigatorType == UNSET) {
        ...
        return () => {
          this.setState({ vrMode: true, worldAlignment: "Gravity" });
        };
      }
    } else if (buttonNum == 2) {
      if (this.state.navigatorType == UNSET) {
        ...
        return () => {
          this.setState({ vrMode: false, worldAlignment: "GravityAndHeading" });
        };
      }
    } else if (buttonNum == 3) {
      if (this.state.navigatorType == UNSET) {
      ...
      if (this.state.navigatorType == UNSET) {
        return () => {
          this.setState({ navigatorType: VR_DEPRECATED_TYPE });
        };
      } else {
        return () => {
          this.setState({ vrMode: false, worldAlignment: "GravityAndHeading" });
